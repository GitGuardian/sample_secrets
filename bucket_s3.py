...
def aws_upload(data: Dict):
    database = aws_lib.connect("AKIAF6BAFJKR45SAWSF5", "hjshuk5ex5u34565AWS657/LKPjhz545d89sjkja")
    database.push(data)
...
MONGO_URI = "mongodb+srv://testuser:hub24aoeu@gg-is-awesome-zg273.mongodb.net/test?retryWrites=true&w=majority"
